...
<head>
  ...
  <title>E-Smantass | <?=$data['nama_siswa']; ?></title>
  <!-- plugins:css -->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
          	<a class="nav-link" href="?page=profil"><img class="menu-icon" src="../vendor/images/menu_icons/10.png" alt="menu icon"> <span class="menu-title">Profil Saya</span></a>
          </li>
           ...
           <li class="nav-item">
            ...
            <?php } ?>
               ...
               <li class="nav-item">
                  <a class="nav-link" href="?page=materi"><img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon">SEMUA MATERI</a>
              </li>
